    ...
    <main className="min-h-screen bg-white p-6 sm:p-12">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="privacy" className="text-sm text-gray-700 cursor-pointer">
                  I agree to the{' '}
                  <a href="/privacy" className="underline text-black" target="_blank" rel="noopener noreferrer">
                    Privacy Policy
                  </a>
                  <span className="block text-xs text-gray-400 mt-0.5">You can cancel your registration up to 24 hours before the tournament.</span>
                </label>
              </div>
        ...
        <div>
          ...
          <p className="text-base text-gray-500 mt-1">Spots Filled</p>
        </div>
