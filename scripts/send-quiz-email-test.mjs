...
const TARGET_EMAIL = 'efeozaktas542@gmail.com';
...
if (!data) {
  console.error(`No approved registration found for ${TARGET_EMAIL}.`);
  process.exit(1);
}
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#0f2a1f;border:1px solid rgba(255,255,255,0.08);border-radius:20px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:28px 28px 8px;">
                <p style="margin:0 0 14px;color:#ffffff;font-size:16px;line-height:1.5;">Hi ${data.first_name},</p>
...
console.log(`Sent quiz email to ${data.email} (${data.first_name} ${data.last_name})`);
console.log(`Quiz link: ${quizUrl}`);
